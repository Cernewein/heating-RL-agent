...
T_MIN = 19 # Minimum temperature that should be achieved inside of the building
T_MAX = 24 # Maximum temperature that should be achieved inside of the building
C_I = 0.143*3.6e6 # Based on Emil Larsen's paper - heat capacity of the building
...
T_AMBIENT = 10 # Ambient temperature
